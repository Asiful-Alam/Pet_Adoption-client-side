...
const petAdoptionCenters = [
  {
    ...
    description:
      "We have a wide variety of pets looking for their forever homes. Come visit us!",
  ...
  },
  {
    ...
    description:
      "Dedicated to rescuing and rehoming animals in need. Join us and find your new best friend!",
    image: "https://i.ibb.co/PQSpThx/adopt-me-pet-02032021.jpg",
  },
  {
    name: "Paw Haven",
    ...
    description:
      "A loving place for abandoned and rescued cats. Find your purrfect companion here.",
    image: "https://i.ibb.co/PQSpThx/adopt-me-pet-02032021.jpg",
  },
  {
    name: "Doggy Delight",
    ...
    description:
      "Your one-stop center for adopting dogs of all breeds and ages. Come and meet your new best friend!",
    image: "https://i.ibb.co/PQSpThx/adopt-me-pet-02032021.jpg",
  },
  {
    name: "Rabbit Retreat",
    ...
    description:
      "Specialized in rescuing and rehoming rabbits. Hop on over to find your fluffy friend!",
    image: "https://i.ibb.co/PQSpThx/adopt-me-pet-02032021.jpg",
  },
];
...
const PetAdoptionCard = ({ center }) => {
  ...
  return (
    ...
    border border-lightGray transition-transform transform hover:-translate-y-1 hover:shadow-2xl">
      <img
      ...
      <div className="px-6 py-4">
        ...
        <p className="text-gray-600 mb-2">
          <strong>Email:</strong>{" "}
          <a href={`mailto:${center.email}`} className="text-blue-500">
            {center.email}
          </a>
        </p>
        <p className="text-gray-600 mb-2">
